...
+(id) requestWithURL:(NSURL*)url type:(RESTRequestType)t bodyData:(NSData*)bodyData resourcePathComponents:(id)firstObject, ... NS_REQUIRES_NIL_TERMINATION;
...
+(id) requestWithURL:(NSURL*)url type:(RESTRequestType)t bodyData:(NSData*)bodyData bodyType:(RESTRequestBodyType)bt resourcePathComponents:(id)firstObject, ... NS_REQUIRES_NIL_TERMINATION;
